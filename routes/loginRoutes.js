...
router
    ...
    .get(checkAuth.not, async (req, res) => {
        ...
        res.render(path.resolve('frontend/login.ejs'), {
            ...
            backgroundGrad: 'linear-gradient(to right top, #b7f9f8, #b1f1ff, #c0e5ff, #ddd7ff, #f9c8f1)',
...
router
    ...
    .get(checkAuth.not, async (req, res) => {
        res.render(path.resolve('frontend/login.ejs'), {
            ...
            backgroundGrad: 'linear-gradient(to left bottom, #ffffff, #e0dafe, #bfb5fb, #9d92f7, #776ff2)',
